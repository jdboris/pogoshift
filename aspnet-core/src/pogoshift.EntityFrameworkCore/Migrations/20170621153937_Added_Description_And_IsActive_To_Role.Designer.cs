...
namespace pogoshift.Migrations
{
    ...
    partial class Added_Description_And_IsActive_To_Role
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("pogoshift.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("pogoshift.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("pogoshift.Authorization.Roles.Role")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("pogoshift.Authorization.Users.User")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("pogoshift.Authorization.Roles.Role", b =>
                {
                    b.HasOne("pogoshift.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("pogoshift.Authorization.Users.User", "DeleterUser")
                        .WithMany()
