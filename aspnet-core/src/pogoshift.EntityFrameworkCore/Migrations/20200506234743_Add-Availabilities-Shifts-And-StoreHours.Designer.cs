...
namespace pogoshift.Migrations
{
    ...
    [Migration("20200506234743_Add-Availabilities-Shifts-And-StoreHours")]
    partial class AddAvailabilitiesShiftsAndStoreHours
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("pogoshift.Availabilities.Availability", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("pogoshift.MultiTenancy.Tenant", b =>
                {
                    ...
                    b.Property<int>("DailyAssociateMinimum")
                        .HasColumnType("int");

                    b.Property<int>("DailyManagerMinimum")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("pogoshift.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("pogoshift.Authorization.Users.User", null)
                        .WithMany("Claims")
